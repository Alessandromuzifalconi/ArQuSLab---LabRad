...
class pvcam_camera_server (LabradServer):
    ...
    def initServer(self):  # Do initialization here
        ...
        print('Camera open')
        # self.read_config(filename = '//ARQUS-NAS/ArQuS Shared/LabRad/servers/PVCAM/PVCAM_ini.txt') 
        # self.set_config()
    ...
    def read_config (self,filename = '//ARQUS-NAS/ArQuS Shared/LabRad/servers/PVCAM/PVCAM_ini.txt'):
