...
class SpectrumM4i6621x8Device:
    ...
    def start_and_enable_trigger(self) -> None:
        """
    ...
    def enable_trigger(self):
        ...
        pyspcm.spcm_dwSetParam_i32(
            self._card, pyspcm.SPC_TRIG_EXT0_LEVEL0, 300)
        # upper Window Trigger level set to 1.0 V
        pyspcm.spcm_dwSetParam_i32(
            self._card, pyspcm.SPC_TRIG_EXT0_LEVEL1, 1000)
